From [Sublime API Reference](https://www.sublimetext.com/docs/api_reference.html): "*Packages/Default/exec.py*"
- Uses [[Sublime Text - Phantoms|phantoms]] to display errors inline
