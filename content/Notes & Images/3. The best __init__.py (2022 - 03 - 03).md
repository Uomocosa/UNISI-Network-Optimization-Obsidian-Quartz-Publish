# Upgrades
With this init you can even use partial import 
- `from .. import somenthing`

Also does not add any significative slow down to the code.
...
class Lazy_Module(types.ModuleType):
	...
	def __call__(self, *args, **kwargs):
		...
		foo = getattr(self.__module__, self.__name__)
